...
public class ToolbarWithFlexibleSpace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toolbar_with_flexible_space);
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(ToolbarWithFlexibleSpace.this);
